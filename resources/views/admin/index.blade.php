                                    ...
                                    <div class="tab-pane active" id="home3" role="tabpanel">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td><img src="{{ asset('assets') }}/images/product/prod2.jpg"
                                                ...
                                                <tr>
                                                    <td><img src="{{ asset('assets') }}/images/product/prod3.jpg"
                                                            alt="prod img" class="img-fluid"></td>
                                                    <td>PNG002653</td>
                                                    <td>Eugine Turner</td>
                                                    <td>04-01-2017</td>
                                                ...
                                                <tr>
                                                    <td><img src="{{ asset('assets') }}/images/product/prod4.jpg"
                                                            alt="prod img" class="img-fluid"></td>
                                                    <td>PNG002156</td>
                                    ...
                                    <div class="tab-pane" id="messages3" role="tabpanel">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td><img src="{{ asset('assets') }}/images/product/prod1.jpg"
                                                            alt="prod img" class="img-fluid"></td>
                                                    <td>PNG002413</td>
                                                    <td>Jane Elliott</td>
                                                    <td>06-01-2017</td>
                                ...
                                <ul class="feed-blog">
                                    <li class="active-feed">
                                        <div class="feed-user-img">
                                            <img src="{{ asset('assets') }}/images/avatar-3.jpg" class="img-radius "
                                                alt="User-Profile-Image">
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-auto text-center">
                                                <img src="{{ asset('assets') }}/images/blog/blog-r-1.jpg" alt="img"
                                            ...
                                            <div class="col-auto text-center">
                                                <img src="{{ asset('assets') }}/images/blog/blog-r-2.jpg" alt="img"
                                                    class="img-fluid img-100">
                                            ...
                                            <div class="col-auto text-center">
                                                <img src="{{ asset('assets') }}/images/blog/blog-r-3.jpg" alt="img"
                                                    class="img-fluid img-100">
                                    ...
                                    <li class="diactive-feed">
                                        <div class="feed-user-img">
                                            <img src="{{ asset('assets') }}/images/avatar-2.jpg" class="img-radius "
                                                alt="User-Profile-Image">
                                        </div>
